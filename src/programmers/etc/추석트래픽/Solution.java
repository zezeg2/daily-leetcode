...
public class Solution {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String Date1 = "2016-09-15 12:30:42.342";
        String Date2 = "12:30:42.342";
        SimpleDateFormat format1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
        SimpleDateFormat format2 = new SimpleDateFormat("HH:mm:ss.SSS");
        System.out.println(format1.parse(Date1));
        System.out.println(format2.parse(Date2));

        System.out.println(format1.parse(Date1).getTime());
        System.out.println(format2.parse(Date2).getTime());
